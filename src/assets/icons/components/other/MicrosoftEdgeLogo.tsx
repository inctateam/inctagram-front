...
const MicrosoftEdgeLogo = forwardRef<ElementRef<typeof SvgIcon>, SVGProps<SVGSVGElement>>(
  (props, ref) => (
...
MicrosoftEdgeLogo.displayName = 'MicrosoftEdgeLogo'

export { MicrosoftEdgeLogo }
